...
namespace NanoSoftGreenMark.Pages
{
    public partial class CategoryComponent:ComponentBase
    {
        ...
        private IEnumerable<Category> _geCategory { get; set; }
        ...
        protected AddCategory addCategory { get; set; }
        protected int ID;
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            var HRDResult = await Service.Categorys.GetAsync(PageIndex,PageSize);
            Categories = HRDResult;
            PageCount = await Service.Categorys.TotalPage(PageSize);
        ...
        public async System.Threading.Tasks.Task AddData(Category data)
        {
            try
            {
                if (data!=null)
                {
                    await Service.Categorys.UpInsertAsync(data);
                }
        ...
        {
            var HRDResult = await Service.Categorys.GetAsync(searchTerm);
            Categories = HRDResult;
